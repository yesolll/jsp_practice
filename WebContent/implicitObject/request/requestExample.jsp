...
<html>
	...
	<body>
	    ...
	    <a href="requestWebInfo.jsp?eng=Hello&kor=안녕">  <!--GET 방식으로 요청-->
	      GET 방식 전송
	    </a>
	    <br />
	    <form action="requestWebInfo.jsp" method="post">  <!--POST 방식으로 요청-->
	        영어 : <input type="text" name="eng" value="Bye" /><br />
	        한글 : <input type="text" name="kor" value="잘 가" /><br />
	    ...
	    <form method="post" action="requestParameter.jsp">  <!--다양한 <input> 태그 사용-->
	        ...
	        <br />
	        관심사항 :
	        <input type="checkbox" name="interests" value="eco" />경제
	        <input type="checkbox" name="interests" value="pol" checked="checked" />정치
	        <input type="checkbox" name="interests" value="ent" />연예<br />
	        자기소개:
